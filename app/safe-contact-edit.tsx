...
export default function SafeContactEditScreen() {
  ...
  const { name: initialName, phone: initialPhone } = useLocalSearchParams<{
    name?: string;
    phone?: string;
  }>();

  const [avatarUri, setAvatarUri] = useState("https://placehold.co/112x112");
  ...
  return (
    <SafeAreaView className="flex-1 bg-background-primary" edges={["top"]}>
      {/* Header */}
      <ScreenHeader title="Turvakontakti" onBack={() => router.back()} />
