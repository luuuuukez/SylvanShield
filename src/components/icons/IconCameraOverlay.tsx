...
/** Small camera icon for avatar overlay buttons (16×16, white stroke by default) */
export function IconCameraOverlay({ color = "white", width = 16, height = 16 }: { color?: string; width?: number; height?: number }) {
  return (
